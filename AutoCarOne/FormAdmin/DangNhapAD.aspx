<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DangNhapAD.aspx.cs" Inherits="AutoCarOne.FormAdmin.DangNhapAD" %>
...
<head>
    ...
    <link href="../Acsset/Bootschap/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link
...
<form id="form1" runat="server">
        <style>
            .bg-login-image {
                background: url(../Acsset/image/anhxe/lanp2.jpg);
                                    ...
                                    <div class="p-5">
                                        ...
                                        <div class="user">
                                            <div class="form-group">
                                                <asp:TextBox ID="tbemali" placeholder="Enter Email Address..."  type="email" runat="server" class="form-control form-control-user"></asp:TextBox>
                                               
                                            </div>
                                            <div class="form-group">
                                          <asp:TextBox ID="tbmatkhau" placeholder="Password"  type="password" runat="server" class="form-control form-control-user"></asp:TextBox>
