<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormDangTin.aspx.cs" Inherits="AutoCarOne.FormDangTin" %>
    ...
    <div class="wrap">
        <div class="new-from">
            ...
            <div class="btn-dangtin" style="margin: 20px 0;">
                ...
                <asp:Button ID="btnDangNgay" runat="server" Text="Đăng ngay" CssClass="btndangtinngay " OnClick="btnDangNgay_Click"/>
