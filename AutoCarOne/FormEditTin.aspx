<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormEditTin.aspx.cs" Inherits="AutoCarOne.FormEditTin" %>
...
.text1 {
    ...
    <div class="wrap">
        <div class="new-from">
            ...
            <div class="list-note">
                <p><i class="fa-solid fa-check"></i> Sửa hình để tin giao hiệu quả và đẹp hơn</p>
            ...
            <div class="file-upload">
                ...
                <div class="box-fileImage">
                <asp:FileUpload ID="FileUpload1" runat="server" CssClass="file-img" />
                <asp:Image ID="Image1" runat="server" CssClass="imgae" Width="100px"/> 
                </div>
                <div class="box-fileImage">
                <asp:FileUpload ID="FileUpload2" runat="server" CssClass="file-img" />
                <asp:Image ID="Image2" runat="server" CssClass="imgae" Width="100px"/> 
                </div>
                <div class="box-fileImage">
                <asp:FileUpload ID="FileUpload3" runat="server" CssClass="file-img"/>
                <asp:Image ID="Image3" runat="server" CssClass="imgae" Width="100px"/> 
                </div>
                <div class="box-fileImage">
                <asp:FileUpload ID="FileUpload4" runat="server" CssClass="file-img"/>
                <asp:Image ID="Image4" runat="server" CssClass="imgae" Width="100px"/> 
                </div>
                <div class="box-fileImage">
                <asp:FileUpload ID="FileUpload5" runat="server"  CssClass="file-img"/>
                <asp:Image ID="Image5" runat="server" Width="100px" CssClass="imgae"/> 
                </div>
                <div class="box-fileImage">
                <asp:FileUpload ID="FileUpload6" runat="server" CssClass="file-img"/>
                <asp:Image ID="Image6" runat="server" CssClass="imgae" Width="100px"/> 
                </div>
                </div>--%>
                 <%-- file upload --%>
                     <%-- 1 --%>
                ...
                <%-- *** --%>
                <div class="box-btnSave">
                    <h6 ><i class="fa-solid fa-pen-to-square"></i>  Bạn hãy lưu ảnh sau khi vừa đổi ảnh </h6>
                    <div style="display: flex; justify-content: center">

                    <asp:Button ID="btnUploadImg" CssClass="btn-img btn-warning" runat="server" Text="Edit-Image"  OnClick="btnUploadImg_Click1"/>
                    </div>
                </div>
            ...
            <div class="postnew">
                <div class="postnew-control" >
                    <span>ID</span>
                    <asp:Label ID="lbID" runat="server" class="input-car labIDOne"></asp:Label>
                </div>
                 <div class="postnew-control">
                    <span>Tên xe</span>
            ...
            <div class="btn-dangtin" style="margin: 20px 0;">
                ...
                <asp:Button ID="btnEdit" runat="server" Text="Sửa" CssClass="btndangtinngay " OnClick="btnEdit_Click"/>
